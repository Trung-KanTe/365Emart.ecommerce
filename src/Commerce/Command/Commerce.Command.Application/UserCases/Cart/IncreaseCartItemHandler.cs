...
namespace Commerce.Command.Application.UserCases.Cart
{
    ...
    /// </summary>
    public record IncreaseCartItemCommand : IRequest<Result>
    {
        /// <summary>
        /// Request to update cartItem, contain cartItem id
        /// </summary>
    ...
    /// </summary>
    public class IncreaseCartItemHandler : IRequestHandler<IncreaseCartItemCommand, Result>
    {
        ...
        /// Handler for update cartItem request
        /// </summary>
        public IncreaseCartItemHandler(ICartItemRepository cartItemRepository, ICartRepository cartRepository)
        {
        ...
        public async Task<Result> Handle(IncreaseCartItemCommand request, CancellationToken cancellationToken)
        {
