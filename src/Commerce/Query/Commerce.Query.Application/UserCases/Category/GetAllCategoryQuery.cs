...
namespace Commerce.Query.Application.UserCases.Category
{
    ...
    /// </summary>
    public class GetAllCategoryQuery : IRequest<Result<List<Entities.Category>>>
    {
    }
    ...
    /// </summary>
    public class GetAllCategoryQueryHandler : IRequestHandler<GetAllCategoryQuery, Result<List<Entities.Category>>>
    {
        ...
        public async Task<Result<List<Entities.Category>>> Handle(GetAllCategoryQuery request,
