...
namespace Commerce.Query.Application.UserCases.Brand
{
    ...
    /// </summary>
    public class GetAllBrandQuery : IRequest<Result<List<Entities.Brand>>>
    {
    }
    ...
    /// </summary>
    public class GetAllBrandQueryHandler : IRequestHandler<GetAllBrandQuery, Result<List<Entities.Brand>>>
    {
        ...
        public async Task<Result<List<Entities.Brand>>> Handle(GetAllBrandQuery request,
